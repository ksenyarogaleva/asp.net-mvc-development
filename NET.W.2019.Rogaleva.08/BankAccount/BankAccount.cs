...
namespace BankAccount
{
    ...
    internal abstract class BankAccount
    {
        ...
        protected decimal billBonuse;
        protected OwnerInfo owner;
        protected List<decimal> bills = new List<decimal>();
        ...
        public void AddNewBill(decimal sum)
        {
            if (sum > 0)
            {
                this.bills.Add(sum);
        ...
        protected void WithdrawAmount(decimal sum, int indexOfBill)
        {
        ...
        /// <param name="indexOfBill">Index of the bill.</param>
        protected abstract void PutAmount(decimal sum, int indexOfBill);
    }
}
